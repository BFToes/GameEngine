...
namespace Graphics.Triangulator
{
    /// <summary>
    ...
    public static class Simplex
    {
        ...
        public static float[] Noise1D(int length, float scale)
        {
        ...
        public static float[,] Noise2D(int width, int height, float scale)
        {
        ...
        public static float[,,] Noise3D(int width, int height, int length, float scale)
        {
        ...
        public static float Position1D(int x, float scale) => Generate(x * scale) * 128 + 128;
        public static float Position2D(int x, int y, float scale) => Generate(x * scale, y * scale) * 128 + 128;
        public static float Position3D(int x, int y, int z, float scale) => Generate(x * scale, y * scale, z * scale) * 128 + 128;
